...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.filename.setGeometry(QtCore.QRect(20, 10, 321, 31))
        self.filename.setObjectName("filename")
        self.browse = QtWidgets.QPushButton(Dialog)
        self.browse.setGeometry(QtCore.QRect(350, 10, 101, 31))
        self.browse.setObjectName("browse")
        self.options = QtWidgets.QComboBox(Dialog)
        self.options.setGeometry(QtCore.QRect(480, 10, 400, 31))
        self.options.setObjectName("options")
        self.selectbtn = QtWidgets.QPushButton(Dialog)
        self.selectbtn.setGeometry(QtCore.QRect(900, 10, 93, 31))
        self.selectbtn.setObjectName("selectbtn")
        self.groupBox_2 = QtWidgets.QGroupBox(Dialog)
        self.groupBox_2.setGeometry(QtCore.QRect(10, 50, 861, 861))
        self.groupBox_2.setObjectName("groupBox_2")
        self.groupBox_3 = QtWidgets.QGroupBox(self.groupBox_2)
        self.groupBox_3.setGeometry(QtCore.QRect(10, 340, 350, 510))
        self.groupBox_3.setObjectName("groupBox_3")
        self.MTMMList = QtWidgets.QListWidget(self.groupBox_3)
        self.MTMMList.setGeometry(QtCore.QRect(20, 50, 161, 221))
        self.MTMMList.setObjectName("MTMMList")
        self.Tractiveeffort = QtWidgets.QCheckBox(self.groupBox_3)
        self.Tractiveeffort.setGeometry(QtCore.QRect(20, 390, 171, 22))
        self.Tractiveeffort.setObjectName("Tractiveeffort")
        self.line_4 = QtWidgets.QFrame(self.groupBox_3)
        self.line_4.setGeometry(QtCore.QRect(140, 290, 20, 141))
        ...
        self.IAButton.setGeometry(QtCore.QRect(10, 10, 150, 31))
        self.IAButton.setObjectName("IAButton")
        self.TAButton = QtWidgets.QRadioButton(self.tab)
        self.TAButton.setGeometry(QtCore.QRect(180, 10, 150, 31))
        ...
        self.time_2d.setGeometry(QtCore.QRect(210, 240, 141, 31))
        self.time_2d.setObjectName("time_2d")
        self.time_3d = QtWidgets.QRadioButton(self.tab)
        self.time_3d.setGeometry(QtCore.QRect(260, 240, 141, 31))
        ...
        self.nodeVoltRadio.setGeometry(QtCore.QRect(20, 615, 171, 20))
        self.nodeVoltRadio.setObjectName("nodeVoltRadio")
        self.branchCurrRadio = QtWidgets.QRadioButton(self.tab)
        self.branchCurrRadio.setGeometry(QtCore.QRect(190, 615, 121, 20))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Timetable.setText(_translate("Dialog", "Time table"))
